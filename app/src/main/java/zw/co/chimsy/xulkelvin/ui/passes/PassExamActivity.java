...
import static zw.co.chimsy.xulkelvin.utils.AppUrls.API_PAYMENT_PASS_EXAM;

public class PassExamActivity extends AppCompatActivity {
    private static final String TAG = PassExamActivity.class.getSimpleName();

    private ProgressDialog pDialog;
    public OkHttpClient client;
    private SQLiteHandler db;

    TextView txt_exam_p_reg_num, txt_exam_p_student_name,
            txt_exam_p_prgrm, txt_exam_p_decision, txt_exam_p_email;
    ImageView image_reg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Student Profile
        txt_exam_p_reg_num = findViewById(R.id.text_exam_p_reg_num);
        txt_exam_p_student_name = findViewById(R.id.text_exam_p_name);
        txt_exam_p_email = findViewById(R.id.text_exam_p_email);
        txt_exam_p_prgrm = findViewById(R.id.text_exam_p_program);
        txt_exam_p_decision = findViewById(R.id.text_exam_p_decision);
        image_reg = findViewById(R.id.imgv_exam_p_reg_status);
    ...
    private void fetchUserProfile() {
        ...
        Log.i(TAG, "fetchUserProfile: " + reg_num + " " + actual_token);
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) {
                try {
                    ...
                    if (!response.isSuccessful()) {
                        hideDialog();
                        //Toast.makeText(PassExamActivity.this, "ERROR: Failed To Reach Servers To Get Your Pass Status", Toast.LENGTH_SHORT).show();
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (reg_status == 1) {
                                txt_exam_p_reg_num.setText(finalRegNum);
                                txt_exam_p_student_name.setText(finalName);
                                txt_exam_p_email.setText(finalEmail);
                                txt_exam_p_prgrm.setText(finalProgram);
                                txt_exam_p_decision.setText(R.string.Exam_OK);
                                txt_exam_p_decision.setTextColor(Color.GREEN);
                                image_reg.setImageResource(R.drawable.image_approved);
                            } else {
                                txt_exam_p_reg_num.setText("");
                                txt_exam_p_student_name.setText("");
                                txt_exam_p_email.setText("");
                                txt_exam_p_prgrm.setText("");
                                txt_exam_p_decision.setText(R.string.Exam_No);
                                txt_exam_p_decision.setTextColor(Color.RED);
